...
//CLIENT EVENTS
client.on("ready", () => {
  console.log("Willow Since 2/2021");
  client.user.setActivity("Your music! Created by CreativePie");
});
...
//DONT DO ANYTHING WITH THIS TOKEN loll yes im talking to you creativepie, yes sir!
client.login(TOKEN);
